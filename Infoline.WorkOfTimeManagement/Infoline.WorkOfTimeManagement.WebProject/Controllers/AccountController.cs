    ...
    public class AccountController : Controller
    {
        ...
        public JsonResult SignUp(SH_User item)
        {
            ...
            if (dbresult.result)
            {
                ...
                EMail.Send(item.email, string.Format("{0} | {1}", "Infoline.WorkOfTimeManagement.WebProject", "Üyelik Bilgisi"), messageText, true);
                ...
                foreach (var yonetici in adminler)
                {
                    ...
                    EMail.Send(yonetici.email, string.Format("{0} | {1}", "Infoline.WorkOfTimeManagement.WebProject", "Üyelik Bilgisi"), messageTextYonetici, true);
                }
        ...
        public JsonResult ForgotPassword(FormCollection form)
        {
            ...
            else
            {
                ...
                if (userm != null)
                {
                    ...
                    EMail.Send(userm.email, string.Format("{0} | {1}", "Infoline.WorkOfTimeManagement.WebProject", "Geçici Şifre Talebi"), messageText, true);
                }
            }
